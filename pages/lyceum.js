          ...
          <div className={styles.flex}>
            <div className={styles.column}>
              ...
              <p className={styles.text}>
                ...
                школы №110. С тех пор школа получила звание Лицея и вошла в
                список лучших школ России. Сегодня, в век цифровых технологий и
                руководствуясь творческим порывом, мы заложили цифровой камень в
                создании новостного портала, через который учащиеся Лицея №110
                им. Л. К. Гришиной будут говорить вами! За нами - будущее,
                поэтому услышьте ГОЛОС МОЛОДЕЖИ ЛИЦЕЯ № 110!
              </p>
            </div>
            <div className={styles.column}>
