...
const UserInfo = ({ avatar = cat.src, id, firstName, lastName, date ='', commentTime}) => {
  ...
  return (
    <div className={styles.user}>
      ...
      {commentTime ?<div className={styles.date}><Time time={date} /></div>:  <p className={styles.date}>{date}</p>}
    </div>
  );
};
